      ...
      <Card.Body>
        ...
        <Collapse in={open}>
          <div>
            ...
            <Card.Text>
              Generally, all properties should be winterized between October 1
              and March 31.
            </Card.Text>
            <Card.Text>
            ...
            <Card.Text>
              AK, CT, IA, IL, IN, MA, ME, MI, MN, MT, ND, NE, NH, NY, OH, PA,
              RI, SD, VT, WI
            </Card.Text>
            <Card.Text>
              ...
              include shutting off the water source either at the curb or the
              main interior water supply if it is not possible to shut it off at
              the curb. Winterization also includes a complete draining of all
              plumbing and heating systems. For properties where water services
              and utilities are shared with other units, such as condominiums,
              the utilities should be maintained. The water service should also
              be maintained if needed for wet winterizations.
            </Card.Text>
          </div>
        </Collapse>
      </Card.Body>
