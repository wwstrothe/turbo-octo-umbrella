    ...
    <Card>
      <Card.Body>
        ...
        <Card.Text>
          ...
          broken. The allowable for any security door and/or crawl space will
          include the cost of boarding and padlock(s). United Inches (UI) is
          calculated by adding length and width (e.g., a 25x60 window is 85 UI).
        </Card.Text>
      </Card.Body>
    </Card>
  );
